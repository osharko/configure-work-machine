...
pacman -S --noconfirm yay binutils base-devel git nodejs-lts-gallium xclip xsel gparted htop make net-tools jdk-openjdk maven dotnet-sdk docker docker-compose popsicle qemu qemu-headless virt-manager iputils openfortivpn
